...
public class JWTEmailFilter extends UsernamePasswordAuthenticationFilter {
  private SecurityConstants securityConstants;
  private AuthenticationManager authenticationManager;

  public JWTEmailFilter(AuthenticationManager authenticationManager, SecurityConstants securityConstants) {
